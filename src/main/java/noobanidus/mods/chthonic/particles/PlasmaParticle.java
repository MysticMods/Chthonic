package noobanidus.mods.chthonic.particles;
...
@OnlyIn(Dist.CLIENT)
public class PlasmaParticle extends SpriteTexturedParticle {
   private final double coordX;
   private final double coordY;
   private final double coordZ;

   private PlasmaParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
      ...
      this.maxAge = (int)(Math.random() * 10.0D) + 90;
   ...
   @OnlyIn(Dist.CLIENT)
   public static class Plasma implements IParticleFactory<BasicParticleType> {
      private final IAnimatedSprite spriteSet;

      public Plasma(IAnimatedSprite sheet) {
         this.spriteSet = sheet;
      }

      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         PlasmaParticle enchantmenttableparticle = new PlasmaParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
