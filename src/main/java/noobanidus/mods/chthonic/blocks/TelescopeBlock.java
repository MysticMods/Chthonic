...
public class TelescopeBlock extends HorizontalFacingBlock {
  public TelescopeBlock(Properties properties) {
    super(properties);
    initializeVoxel(VoxelUtil.multiOr(Block.makeCuboidShape(6, 13, 0,10, 17, 12), Block.makeCuboidShape(7, 14, -4,9, 16, 0), Block.makeCuboidShape(6, 14, -3,7, 18, -2), Block.makeCuboidShape(4, 0, 4,12, 10, 12)));
  }
}
